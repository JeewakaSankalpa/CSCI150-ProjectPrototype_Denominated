...
public class studentInfo1 implements Serializable {
    @Transient
    ...
    public studentInfo1(Integer customerId) {
        this.customerId = customerId;
    }

    public studentInfo1(Integer customerId, Character discountCode, String zip) {
        this.customerId = customerId;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof studentInfo1)) {
            return false;
        }
        studentInfo1 other = (studentInfo1) object;
    ...
    public String toString() {
        return "class_management.Customer[ customerId=" + customerId + " ]";
    }
